...
export type LeadEventDefinition = {
  ...
  readonly browserSignal: boolean;
...
export declare const LEAD_BROWSER_SIGNAL_EVENT_NAMES: readonly [
  'lead_chat_first_message_sent',
  'lead_click_to_call',
  'lead_click_to_text',
  'lead_click_email',
...
export type LeadBrowserSignalEventName = (typeof LEAD_BROWSER_SIGNAL_EVENT_NAMES)[number];
...
export declare function isLeadBrowserSignalEventName(
  value: string,
): value is LeadBrowserSignalEventName;
