export const QUOTE_PAGE_COPY = Object.freeze({
  en: {
    ...
    checklist: [
      ...
      'What needs help and which area is affected',
      'How you want us to reply, plus any photos you already have',
    ],
    ...
    requestCtaTitle: 'Need a quote?',
    requestCtaBody: 'Use the quote page to send vehicle details and photos without calling first.',
    requestCtaButton: 'Open quote page',
  },
  es: {
    lead:
    ...
    checklist: [
      ...
      'Qué necesita reparación y qué zona está afectada',
      'Cómo prefieres que te respondamos y cualquier foto que ya tengas',
    ],
    ...
    contactTitle: '¿Necesitas información general del taller?',
    contactBody: 'Usa la página de contacto para horarios, direcciones, teléfono, texto y correo.',
    contactButton: 'Abrir contacto',
    requestCtaTitle: '¿Necesitas una cotización?',
    requestCtaBody: 'Usa la página de cotización para enviar datos del vehículo y fotos sin llamar primero.',
    requestCtaButton: 'Abrir cotización',
  },
  vi: {
    lead:
    ...
    checklist: [
      'Năm, hãng và mẫu xe',
      'Phần nào cần sửa và khu vực nào bị ảnh hưởng',
      'Cách bạn muốn chúng tôi trả lời và mọi ảnh bạn đã có',
    ],
    ...
    contactTitle: 'Bạn cần thông tin chung của cửa hàng?',
    contactBody: 'Dùng trang liên hệ để xem giờ làm việc, chỉ đường, số điện thoại, nhắn tin và email.',
    contactButton: 'Mở trang liên hệ',
    requestCtaTitle: 'Bạn cần báo giá?',
    requestCtaBody: 'Dùng trang báo giá để gửi thông tin xe và ảnh mà không cần gọi trước.',
    requestCtaButton: 'Mở trang báo giá',
  },
  'zh-hans': {
    lead:
    ...
    contactTitle: '需要门店信息吗？',
    contactBody: '联系页面提供营业时间、路线、电话、短信和电子邮件。',
    contactButton: '打开联系页面',
    requestCtaTitle: '需要报价吗？',
    requestCtaBody: '使用报价页面提交车辆信息和照片，无需先打电话。',
    requestCtaButton: '打开报价页面',
  },
  tl: {
    lead:
    ...
    checklist: [
      ...
      'Ano ang kailangang ayusin at aling bahagi ang apektado',
      'Paano mo gustong makatanggap ng sagot at anumang larawan na mayroon ka na',
    ],
    ...
    contactTitle: 'Kailangan mo ba ng pangkalahatang info ng shop?',
    contactBody: 'Gamitin ang contact page para sa oras, direksyon, tawag, text, at email.',
    contactButton: 'Buksan ang contact page',
    requestCtaTitle: 'Kailangan mo ba ng quote?',
    requestCtaBody: 'Gamitin ang quote page para magpadala ng detalye ng sasakyan at mga larawan kahit hindi muna tumawag.',
    requestCtaButton: 'Buksan ang quote page',
  },
  id: {
    lead:
    ...
    checklist: [
      ...
      'Bagian yang perlu diperbaiki dan area yang terdampak',
      'Cara Anda ingin kami membalas serta foto yang sudah Anda miliki',
    ],
    ...
    contactTitle: 'Butuh info umum bengkel?',
    contactBody: 'Gunakan halaman kontak untuk jam operasional, arah, telepon, pesan, dan email.',
    contactButton: 'Buka halaman kontak',
    requestCtaTitle: 'Butuh estimasi?',
    requestCtaBody: 'Gunakan halaman estimasi untuk mengirim detail kendaraan dan foto tanpa harus menelepon dulu.',
    requestCtaButton: 'Buka halaman estimasi',
  },
  fa: {
    lead:
    ...
    checklist: [
      ...
      'اینکه چه چیزی نیاز به تعمیر دارد و کدام بخش آسیب دیده است',
      'روش پاسخ دلخواه شما و هر عکسی که از قبل دارید',
    ],
    ...
    contactTitle: 'به اطلاعات کلی کارگاه نیاز دارید؟',
    contactBody: 'برای ساعت کاری، مسیر، تماس، پیامک و ایمیل از صفحه تماس استفاده کنید.',
    contactButton: 'باز کردن صفحه تماس',
    requestCtaTitle: 'به برآورد نیاز دارید؟',
    requestCtaBody: 'برای ارسال مشخصات خودرو و عکس‌ها بدون تماس اولیه از صفحه برآورد استفاده کنید.',
    requestCtaButton: 'باز کردن صفحه برآورد',
  },
  te: {
    lead:
    ...
    checklist: [
      ...
      'ఏం సహాయం కావాలి, ఏ భాగం ప్రభావితమైంది',
      'మేము ఎలా స్పందించాలనుకుంటున్నారు మరియు మీ దగ్గర ఉన్న ఫోటోలు',
    ],
    ...
    contactTitle: 'షాప్ సాధారణ సమాచారం కావాలా?',
    contactBody: 'గంటలు, దిశలు, కాల్, టెక్స్ట్, ఇమెయిల్ కోసం కాంటాక్ట్ పేజీని ఉపయోగించండి.',
    contactButton: 'కాంటాక్ట్ పేజీ తెరవండి',
    requestCtaTitle: 'కోట్ కావాలా?',
    requestCtaBody: 'ముందుగా కాల్ చేయకుండా వాహనం వివరాలు, ఫోటోలు పంపడానికి కోట్ పేజీని ఉపయోగించండి.',
    requestCtaButton: 'కోట్ పేజీ తెరవండి',
  },
  fr: {
    lead:
    ...
    checklist: [
      ...
      'Ce qui doit être réparé et la zone concernée',
      'La façon dont vous souhaitez être recontacté et les photos déjà disponibles',
    ],
    ...
    contactTitle: 'Besoin des infos générales de l’atelier ?',
    contactBody: 'Utilisez la page contact pour les horaires, l’itinéraire, le téléphone, les SMS et l’email.',
    contactButton: 'Ouvrir la page contact',
    requestCtaTitle: 'Besoin d’un devis ?',
    requestCtaBody: 'Utilisez la page devis pour envoyer les détails du véhicule et des photos sans appeler d’abord.',
    requestCtaButton: 'Ouvrir la page devis',
  },
  ko: {
    lead:
    ...
    contactTitle: '매장 일반 정보가 필요하신가요?',
    contactBody: '영업시간, 길찾기, 전화, 문자, 이메일은 문의 페이지를 이용해 주세요.',
    contactButton: '문의 페이지 열기',
    requestCtaTitle: '견적이 필요하신가요?',
    requestCtaBody: '전화 전에 차량 정보와 사진을 보내려면 견적 페이지를 이용해 주세요.',
    requestCtaButton: '견적 페이지 열기',
  },
  hi: {
    lead:
    ...
    contactTitle: 'क्या आपको दुकान की सामान्य जानकारी चाहिए?',
    contactBody: 'समय, दिशा, कॉल, टेक्स्ट और ईमेल के लिए संपर्क पेज का उपयोग करें।',
    contactButton: 'संपर्क पेज खोलें',
    requestCtaTitle: 'क्या आपको कोट चाहिए?',
    requestCtaBody: 'पहले कॉल किए बिना वाहन की जानकारी और फोटो भेजने के लिए कोट पेज का उपयोग करें।',
    requestCtaButton: 'कोट पेज खोलें',
  },
  pa: {
    lead:
    ...
    contactTitle: 'ਕੀ ਤੁਹਾਨੂੰ ਸ਼ਾਪ ਦੀ ਆਮ ਜਾਣਕਾਰੀ ਚਾਹੀਦੀ ਹੈ?',
    contactBody: 'ਸਮਾਂ, ਦਿਸ਼ਾਵਾਂ, ਕਾਲ, ਟੈਕਸਟ ਅਤੇ ਈਮੇਲ ਲਈ ਸੰਪਰਕ ਪੇਜ ਵਰਤੋ.',
    contactButton: 'ਸੰਪਰਕ ਪੇਜ ਖੋਲ੍ਹੋ',
    requestCtaTitle: 'ਕੀ ਤੁਹਾਨੂੰ ਕੋਟ ਚਾਹੀਦਾ ਹੈ?',
    requestCtaBody: 'ਫੋਟੋਆਂ ਅਤੇ ਵਾਹਨ ਵੇਰਵੇ ਭੇਜਣ ਲਈ ਕੋਟ ਪੇਜ ਵਰਤੋ, ਪਹਿਲਾਂ ਕਾਲ ਕਰਨ ਦੀ ਲੋੜ ਨਹੀਂ.',
    requestCtaButton: 'ਕੋਟ ਪੇਜ ਖੋਲ੍ਹੋ',
  },
  'pt-br': {
    lead:
    ...
    checklist: [
      ...
      'O que precisa de reparo e qual área foi afetada',
      'Como você prefere receber a resposta e quaisquer fotos que já tenha',
    ],
    ...
    contactTitle: 'Precisa de informações gerais da oficina?',
    contactBody: 'Use a página de contato para horários, rotas, telefone, mensagem e email.',
    contactButton: 'Abrir página de contato',
    requestCtaTitle: 'Precisa de orçamento?',
    requestCtaBody: 'Use a página de orçamento para enviar dados do veículo e fotos sem precisar ligar primeiro.',
    requestCtaButton: 'Abrir página de orçamento',
  },
  'zh-hant': {
    lead:
    ...
    contactTitle: '需要店家一般資訊嗎？',
    contactBody: '聯絡頁面提供營業時間、路線、電話、簡訊與電子郵件。',
    contactButton: '開啟聯絡頁面',
    requestCtaTitle: '需要報價嗎？',
    requestCtaBody: '使用報價頁面提交車輛資訊和照片，不必先打電話。',
    requestCtaButton: '開啟報價頁面',
  },
  ja: {
    lead:
    ...
    contactTitle: '店舗情報が必要ですか？',
    contactBody: '営業時間、行き方、電話、SMS、メールはお問い合わせページをご利用ください。',
    contactButton: 'お問い合わせページを開く',
    requestCtaTitle: '見積もりが必要ですか？',
    requestCtaBody: '車両情報と写真を先に送りたい場合は、見積もりページをご利用ください。',
    requestCtaButton: '見積もりページを開く',
  },
  ar: {
    lead:
    ...
    contactTitle: 'هل تحتاج إلى معلومات عامة عن الورشة؟',
    contactBody: 'استخدم صفحة الاتصال لمعرفة الساعات والاتجاهات والهاتف والرسائل والبريد الإلكتروني.',
    contactButton: 'افتح صفحة الاتصال',
    requestCtaTitle: 'هل تحتاج إلى عرض سعر؟',
    requestCtaBody: 'استخدم صفحة عرض السعر لإرسال تفاصيل السيارة والصور من دون الاتصال أولاً.',
    requestCtaButton: 'افتح صفحة عرض السعر',
  },
  ru: {
    lead:
    ...
    contactTitle: 'Нужна общая информация о мастерской?',
    contactBody: 'Используйте страницу контактов для часов работы, маршрута, звонка, сообщения и email.',
    contactButton: 'Открыть страницу контактов',
    requestCtaTitle: 'Нужна оценка?',
    requestCtaBody: 'Используйте страницу оценки, чтобы отправить данные автомобиля и фото без предварительного звонка.',
    requestCtaButton: 'Открыть страницу оценки',
  },
  ta: {
    lead:
    ...
    contactTitle: 'கடையின் பொது தகவல் வேண்டுமா?',
    contactBody: 'நேரம், வழிகள், அழைப்பு, குறுஞ்செய்தி, மின்னஞ்சலுக்கு தொடர்பு பக்கத்தை பயன்படுத்துங்கள்.',
    contactButton: 'தொடர்பு பக்கத்தைத் திறக்கவும்',
    requestCtaTitle: 'மதிப்பீடு வேண்டுமா?',
    requestCtaBody: 'முதலில் அழைக்காமல் வாகன விவரங்கள் மற்றும் புகைப்படங்களை அனுப்ப மதிப்பீட்டு பக்கத்தை பயன்படுத்துங்கள்.',
    requestCtaButton: 'மதிப்பீட்டு பக்கத்தைத் திறக்கவும்',
  },
});
