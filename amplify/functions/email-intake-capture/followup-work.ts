...
export function createEmailFollowupWork(args: {
  ...
  const record = createLeadFollowupWorkItem({
    ...
    leadSummary: args.evaluation.leadSummary,
    customerResponsePolicy: args.evaluation.customerResponsePolicy,
    customerResponsePolicyReason: args.evaluation.customerResponsePolicyReason,
