...
export type JourneyInteractionEventName = LeadInteractionEventName;

export type JourneyInteractionInput = {
  eventName: JourneyInteractionEventName;
  occurredAtMs: number;
  recordedAtMs: number;
...
export function buildJourneyInteraction(input: JourneyInteractionInput): {
  journey: Journey;
  event: JourneyEvent;
} {
