...
import {
  buildLeadAdminConversionFeedbackDetail,
  type LeadAdminConversionFeedbackDetail,
} from './admin-conversion-feedback.ts';
...
export function toLeadAdminRecordSummary(args: {
  ...
  return {
    ...
    conversion_feedback_detail: buildLeadAdminConversionFeedbackDetail({
