...
export function deriveLegacyQuoteOutreach(record: LegacyQuoteOutreachLike): LeadOutreachSnapshot {
...
export function buildLegacyQuoteOutreachEvents(args: {
  journeyId: string;
  leadRecordId: string;
  occurredAtMs: number;
  recordedAtMs: number;
  record: LegacyQuoteOutreachLike;
