...
import { createQuoteSubmissionRecord, QUOTE_REQUEST_TTL_DAYS } from './quote-request.ts';

test('createQuoteSubmissionRecord creates a queued request with canonical lead linkage', () => {
