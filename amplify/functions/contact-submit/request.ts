...
import { normalizeString } from '../_lead-core/domain/quote-request.ts';
...
export type ParseContactSubmitRequestResult =
  | { ok: true; request: ContactSubmitRequest }
...
): ParseContactSubmitRequestResult {
